...
def main(env_name, num_episodes, gamma, lam, deepest,bl,c,kl_targ, batch_size, init_logvar):
    """ Main training loop
    ...
    # env: <TimeLimit<InvertedPendulumBulletEnv<InvertedPendulumBulletEnv-v0>>>
    # obs_dim: 5
    # act_dim: 1 
